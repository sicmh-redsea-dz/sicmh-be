...
-- MedIT: plantillas e instancias de consentimientos informados (por tenant).
-- Este bloque no se ejecuta desde la aplicacion; debe aplicarse manualmente.
...
CREATE TABLE IF NOT EXISTS consentimiento_plantillas (
  ...
  CONSTRAINT fk_consentimiento_plantilla_creador FOREIGN KEY (created_by)
...
CREATE TABLE IF NOT EXISTS consentimiento_plantilla_versiones (
  ...
  CONSTRAINT fk_consentimiento_version_plantilla FOREIGN KEY (plantilla_id)
    REFERENCES consentimiento_plantillas(id),
  CONSTRAINT fk_consentimiento_version_creador FOREIGN KEY (created_by)
    REFERENCES usuarios(UsuarioID)
);
...
CREATE TABLE IF NOT EXISTS consentimiento_instancias (
  ...
  CONSTRAINT fk_consentimiento_instancia_template FOREIGN KEY (template_id)
    REFERENCES consentimiento_plantillas(id),
  CONSTRAINT fk_consentimiento_instancia_version FOREIGN KEY (template_version_id)
    REFERENCES consentimiento_plantilla_versiones(id),
  CONSTRAINT fk_consentimiento_instancia_patient FOREIGN KEY (patient_id)
    REFERENCES pacientes(PacienteID),
  CONSTRAINT fk_consentimiento_instancia_record FOREIGN KEY (record_id)
    REFERENCES historia_medica(HistoriaID),
  CONSTRAINT fk_consentimiento_instancia_doctor FOREIGN KEY (doctor_id)
    REFERENCES personal(PersonalID),
  CONSTRAINT fk_consentimiento_instancia_attachment FOREIGN KEY (attachment_id)
    REFERENCES adjuntos_clinicos(id),
  CONSTRAINT fk_consentimiento_instancia_created_by FOREIGN KEY (created_by)
    REFERENCES usuarios(UsuarioID),
